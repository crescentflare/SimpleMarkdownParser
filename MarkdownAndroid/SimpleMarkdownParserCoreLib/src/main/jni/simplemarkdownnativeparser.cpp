...
Java_com_crescentflare_simplemarkdownparsercore_SimpleMarkdownNativeParser_findNativeTags(JNIEnv *env, jobject instance, jstring markdownText_)
{
...
Java_com_crescentflare_simplemarkdownparsercore_SimpleMarkdownNativeParser_escapedSubstring(JNIEnv *env, jobject instance, jstring text_, jint bytePosition, jint length)
{
