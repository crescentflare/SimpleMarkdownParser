...
public class SimpleMarkdownTagFinderTest {
    ...
    public void testFindTagsSections() {
        ...
        WrappedMarkdownTag[] expectedTags = new WrappedMarkdownTag[] {
            ...
            new WrappedMarkdownTag(MarkdownTag.Type.UnorderedList, 1, "Bullet item"),
            new WrappedMarkdownTag(MarkdownTag.Type.Line, "* Second item"),
            new WrappedMarkdownTag(MarkdownTag.Type.UnorderedList, 1, "Second item\n  With some text"),
    ...
    public void testFindTagsStyling() {
        ...
        WrappedMarkdownTag[] expectedTags = new WrappedMarkdownTag[] {
            ...
            new WrappedMarkdownTag(MarkdownTag.Type.UnorderedList, 1, "A bullet list"),
            new WrappedMarkdownTag(MarkdownTag.Type.Line, "- Second bullet item"),
            new WrappedMarkdownTag(MarkdownTag.Type.UnorderedList, 1, "Second bullet item"),
            new WrappedMarkdownTag(MarkdownTag.Type.Line, "* A nested item"),
            new WrappedMarkdownTag(MarkdownTag.Type.UnorderedList, 2, "A nested item"),
            new WrappedMarkdownTag(MarkdownTag.Type.Line, "* Third bullet item"),
            new WrappedMarkdownTag(MarkdownTag.Type.UnorderedList, 1, "Third bullet item"),
            new WrappedMarkdownTag(MarkdownTag.Type.Line, "1. Nested first item"),
            new WrappedMarkdownTag(MarkdownTag.Type.OrderedList, 2, "Nested first item"),
            new WrappedMarkdownTag(MarkdownTag.Type.Line, "2. Nested second item"),
            new WrappedMarkdownTag(MarkdownTag.Type.OrderedList, 2, "Nested second item"),
