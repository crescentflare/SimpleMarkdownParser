...
class SimpleMarkdownTagFinderTests: XCTestCase {
    ...
    func testFindSectionTags() {
        ...
        let expectedTags = [
            ...
            WrappedMarkdownTag(type: .unorderedListItem, weight: 1, text: "Bullet item"),
            WrappedMarkdownTag(type: .line, text: "* Second item"),
            WrappedMarkdownTag(type: .unorderedListItem, weight: 1, text: "Second item\n  With some text"),
    ...
    func testFindStylingTags() {
        ...
        let expectedTags = [
            ...
            WrappedMarkdownTag(type: .unorderedListItem, weight: 1, text: "A bullet list"),
            WrappedMarkdownTag(type: .line, text: "- Second bullet item"),
            WrappedMarkdownTag(type: .unorderedListItem, weight: 1, text: "Second bullet item"),
            WrappedMarkdownTag(type: .line, text: "* A nested item"),
            WrappedMarkdownTag(type: .unorderedListItem, weight: 2, text: "A nested item"),
            WrappedMarkdownTag(type: .line, text: "* Third bullet item"),
            WrappedMarkdownTag(type: .unorderedListItem, weight: 1, text: "Third bullet item"),
            WrappedMarkdownTag(type: .line, text: "1. Nested first item"),
            WrappedMarkdownTag(type: .orderedListItem, weight: 2, text: "Nested first item"),
            WrappedMarkdownTag(type: .line, text: "2. Nested second item"),
            WrappedMarkdownTag(type: .orderedListItem, weight: 2, text: "Nested second item"),
